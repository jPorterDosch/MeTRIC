...
for dir in depth_dirs:
    ...
    new_depth_dir = (
        os.path.expanduser(
            "~/scratch/data/kitti/depth_selection/val_selection_cropped/groundtruth_depth_gathered/"
        )
        + dir.split("/")[-4]
        + "_02"
    )
    ...
    new_image_dir = (
        os.path.expanduser(
            "~/scratch/data/kitti/depth_selection/val_selection_cropped/image_gathered/"
        )
        + dir.split("/")[-4]
        + "_02"
    )
    ...
    for depth_file in sorted(
        ...
        :110
    ]:  # ../data/kitti/val/2011_09_26_drive_0002_sync/proj_depth/groundtruth/image_02/0000000005.png
        ...
        image_file = depth_file.replace("val", mid).replace(
            "proj_depth/groundtruth/image_02", "image_02/data"
        )
        print(image_file)
