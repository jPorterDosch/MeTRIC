...
import os
import shutil
depth_dirs = glob.glob(os.path.expanduser("~/scratch/data/kitti/val/*/proj_depth/groundtruth/image_02"))
for dir in depth_dirs:
    # new depth dir
    new_depth_dir = os.path.expanduser("~/scratch/data/kitti/depth_selection/val_selection_cropped/groundtruth_depth_gathered/") + dir.split("/")[-4]+"_02"
    # print(new_depth_dir)
    new_image_dir = os.path.expanduser("~/scratch/data/kitti/depth_selection/val_selection_cropped/image_gathered/") + dir.split("/")[-4]+"_02"
...
print("KITTI preprocessing successful.")