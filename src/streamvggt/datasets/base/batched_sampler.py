# Aspect-ratio-aware batched sampler for the streamvggt dataset pipeline.
#
# Copied verbatim from DUSt3R (dust3r.datasets.base.batched_sampler); it has no
# dust3r dependencies of its own.
import numpy as np
