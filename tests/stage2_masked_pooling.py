...
def check_c():
    ...
    from streamvggt.depth_cond import DepthCondCfg, DepthConditioner

    cfg = DepthCondCfg(injection="head", encoder="identity")
    cond = DepthConditioner(
        cfg, {"features": 8, "num_scales": 4, "heads": ["depth"]}, patch_size=ps
    )
